        ...
        <form method="POST" action="/rosters/{{ $roster->id }}/roles">
            ...
            <div class="max-w-sm m-auto">
                <div class="import-guild-members-list mb-4">
                    <table class="roster-members-table px-2 w-full">
                        <thead>
                            <th>Character</th>
                            <th>Main Spec</th>
                            <th>Off Spec</th>
                ...
                <button type="submit" name="updateRoles" class="btn bg-blue hover:bg-blue-darker text-white rounded px-2 py-2">Update Roles</button>
            </div>
        </form>
    </div>
